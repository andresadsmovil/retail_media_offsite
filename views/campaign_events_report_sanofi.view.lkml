view: campaign_events_report_sanofi {
  sql_table_name: `sources.campaign_events_report_sanofi` ;;
  ...
  measure: count {
    type: count
    drill_fields: [category_name, product_name, campaing_name, trademark_name]
  }
}
